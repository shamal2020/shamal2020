...
if runTest:
    ...
    # Navigate to Company Certificates Page
    navToSublink(browser, pause, By, 'Company','Certificates')
    fPause()
    ...
    button = browser.find_element_by_xpath('//main/div/div[2]/div/div[2]/div[2]/div/div/div[1]/div[2]/div/div[1]')
    
    # CLICKING EXPIRING WITHIN 180 DAYS FILTER
    button.click()
    fPause(2)
    ...
    print('...........SANITY PASS: COUNT VALIDATION OF EXPIRING WITHIN 180 DAYS FILTER SUCCESSFUL...........')
    fPause(2)
    ...
    #LOCATING AND CLICKING THE RESET BUTTON
