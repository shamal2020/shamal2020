//3/9/2020
//This script searches for a userid that contains "sanity" and deletes it.  If there are none it will fail.  If the Access Manager scripts are run in order this won't be an issue.
...
public class TC16DeleteUser extends testEnvironment {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("\nDeleteUser.main()--userBeforeCount = "+userBeforeCount);
        
        //Filter on Users
        driver.findElement(By.xpath("//html/body/div[1]/div/div/div/div/div[2]/main/div/div[2]/div[2]/div[4]/div/div/div/div/div[2]/div[1]/div/div[2]/button")).click();
        Thread.sleep(3000);
	    ...
	    driver.findElement(By.xpath("//html/body/div[1]/div/div/div/div/div[2]/main/div/div[2]/div[2]/div[2]/div/input")).sendKeys("Sanity");
	    ...
	    //Delete User
	    driver.findElement(By.xpath("//html/body/div[1]/div/div/div/div/div[2]/main/div/div[2]/div[2]/div[2]/div[1]/div[3]/div/div/div/div[2]/div/div/div/div/div[4]/div[2]/div/div/div/button")).click();
	    driver.findElement(By.xpath("//html/body/div[1]/div/div/div/div/div[2]/main/div/div[2]/div[2]/div[2]/div[1]/div[3]/div/div/div/div[2]/div/div/div/div/div[4]/div[2]/div/div/div/div[2]/div/div/div[3]/button[2]")).click();
	  ...
	  //Capture User Count ** AFTER
	   ...
	   //Get after Count
        for (WebElement webElement : userAfterCountList) {
            System.out.println("DeleteUser.main()--userAfterCount = " +webElement.getText());
            userAfterCount = Integer.parseInt(webElement.getText());
        } 
        
        if (userBeforeCount != 0 && userAfterCount != 0 && userBeforeCount > userAfterCount)
        {
        	System.out.println("DeleteUser.main() -- SANITY TEST PASS");
	    } else {
	    	System.out.println("DeleteUser.main() -- SANITY TEST FAIL");
	    }
